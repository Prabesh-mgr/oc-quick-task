...
import { getAllUsers, getUserData } from '../controller/UsersController/GetUserData.js';
...
import { changeUserName } from '../controller/UsersController/EditUserData.js';
...
router.patch('/users',verifyToken, changeUserName);
